                            ...
                            <div className="col-lg-9">
                                ...
                                <div className="box info-bar">
                                    ...
                                    <div className="col-md-12 col-lg-7 products-number-sort">
                                        ...
                                        <div className="products-number"><strong>Show</strong><a href="#" className="btn btn-sm btn-primary">12</a><a href="#" className="btn btn-outline-secondary btn-sm">24</a><span>products</span></div>
